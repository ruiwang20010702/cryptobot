...
def test_calc_weights_very_high(mock_accuracy):
    ...
    mock_accuracy.return_value = {
        "technical": {"total": 35, "correct": 28, "accuracy": 0.80},
    }
...
def test_calc_weights_high(mock_accuracy):
    """测试高准确率 → high 权重"""
    mock_accuracy.return_value = {
        "technical": {"total": 35, "correct": 23, "accuracy": 0.67},
    }
    result = calc_analyst_weights()
...
def test_calc_weights_very_low(mock_accuracy):
    """测试极低准确率 → very_low 权重"""
    mock_accuracy.return_value = {
        "sentiment": {"total": 35, "correct": 9, "accuracy": 0.25},
    }
    result = calc_analyst_weights()
...
def test_calc_weights_low(mock_accuracy):
    """测试低准确率 → low 权重"""
    mock_accuracy.return_value = {
        "sentiment": {"total": 35, "correct": 15, "accuracy": 0.42},
    }
    result = calc_analyst_weights()
...
def test_calc_weights_normal(mock_accuracy):
    """测试普通准确率 → normal 权重"""
    mock_accuracy.return_value = {
        "onchain": {"total": 35, "correct": 19, "accuracy": 0.55},
    }
    result = calc_analyst_weights()
...
def test_calc_weights_insufficient_samples(mock_accuracy):
    ...
    mock_accuracy.return_value = {
        "technical": {"total": 15, "correct": 15, "accuracy": 1.0},
        "sentiment": {"total": 10, "correct": 0, "accuracy": 0.0},
    }
    result = calc_analyst_weights()
...
def test_build_weights_context_with_adjustments(mock_accuracy):
    ...
    mock_accuracy.return_value = {
        "technical": {"total": 35, "correct": 28, "accuracy": 0.80},
        "onchain": {"total": 35, "correct": 21, "accuracy": 0.60},
        "sentiment": {"total": 35, "correct": 12, "accuracy": 0.33},
        "fundamental": {"total": 35, "correct": 20, "accuracy": 0.56},
    }
...
def test_build_weights_context_no_adjustments(mock_accuracy):
    """测试无调整时返回空字符串"""
    mock_accuracy.return_value = {
        "technical": {"total": 35, "correct": 21, "accuracy": 0.60},
        "onchain": {"total": 35, "correct": 21, "accuracy": 0.60},
    }
    ctx = build_weights_context()
    assert ctx == ""
